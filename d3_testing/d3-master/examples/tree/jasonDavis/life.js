...
var cluster = d3.layout.cluster()
    .size([360, 1])
    .sort(null)
    .value(function(d) { console.log(d); return d.length; })
    .children(function(d) { console.log(d); return d.branchset; })
...
d3.text("life.txt", function(text) {
  ...
  var label = vis.selectAll("text")
    ...
    .enter().append("text")
      ...
      .attr("transform", function(d) { return "rotate(" + (d.x - 90) + ")translate(" + (r +10) + ")rotate(" + (d.x < 180 ? 0 : 180) + ")"; })
